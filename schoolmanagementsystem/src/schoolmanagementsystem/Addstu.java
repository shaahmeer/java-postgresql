...
public class Addstu extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            String sql= "INSERT INTO public.student1( name, father_name, phone_number, fphone_number, class, rollno, address) VALUES (?, ?, ?, ?, ?, ?, ?)";
//String sql1 = "UPDATE public.addteacher SET id, name, spec, subject values (?,?,?,?)";
            String sna = sn.getText();
            String name = String.valueOf(sna);

            String fna = fn.getText();
            String fname = String.valueOf(fna);

            String text = add.getText();
            String add = String.valueOf(text);

            String text1 = pn.getText();
            int number1 = Integer.parseInt(text1);

            System.out.println(number1);
            String ftext1 = fpn.getText();
            int fnumber1 = Integer.parseInt(ftext1);
            //System.out.println(fnumber1);
            String ct = cl.getText();
            int ct1 = Integer.parseInt(ct);
            //System.out.println(ct1);
            String rroll = roll.getText();
            int roll1 = Integer.parseInt(rroll);
            //System.out.println(roll1);

            PreparedStatement ptstmt= conn.prepareStatement(sql);
           // ptstmt.setInt(1, (number));
            ptstmt.setString(1,name);
            //System.out.println(sn.getText());
            ptstmt.setString(2, fname.toString());


            ptstmt.setInt(3, number1);
            System.out.println(number1);
            ptstmt.setInt(4, fnumber1);
            System.out.println(fnumber1);
            ptstmt.setInt(5, ct1);
            System.out.println(ct1);
            ptstmt.setInt(6, roll1);
            System.out.println(roll1);
            ptstmt.setString(7, add.toString());
