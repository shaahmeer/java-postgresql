...
public class editteacher extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sna = name.getText();
        String name = String.valueOf(sna);

        String fna = spec.getText();
        String spec = String.valueOf(fna);

        String text = subject.getText();
        String sub1 = String.valueOf(text);
        ...
        try{
            ...
            String sql = "UPDATE addteacher SET  name='"+name+"', spec='"+spec+"' ,subject='"+sub1+"' WHERE  id="+number1;
