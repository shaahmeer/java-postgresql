...
public class editstu extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       // System.out.println(fname);
        ...
        String rolly = roll.getText();
        int role = Integer.parseInt(rolly);
        ...
        */
        try{
           ...
           String sql = "UPDATE student1 SET  name='"+name+"', father_name='"+fname+"', phone_number="+number1+", fphone_number="+fnumber1+", class="+ct1+", rollno="+role+", address='"+add+"' WHERE id="+id;
           ...
           /* //ptstmt.setInt(1,id);
            ...
            System.out.println(name);
            ptstmt.setString(3, fname);
            System.out.println(fname);


            ptstmt.setInt(4, number1);
            System.out.println(number1);
            ptstmt.setInt(5, fnumber1);
            System.out.println(fnumber1);
            ptstmt.setInt(6, ct1);
            System.out.println(ct1);
            ptstmt.setInt(7, role);
            System.out.println(role);
            ptstmt.setString(8, add);*/
            //System.out.println(add);
