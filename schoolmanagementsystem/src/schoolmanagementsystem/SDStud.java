...
public class SDStud extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            tm.setRowCount(0);
            while(rs.next()){
            Object o[]= {rs.getInt("id"),rs.getString("name"),rs.getString("father_name"),rs.getInt("phone_number"),
            rs.getInt("fphone_number"),rs.getString("class"),rs.getString("rollno"),rs.getString("address")};
            tm.addRow(o);
            }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String add = String.valueOf(sd);
        try{
            Connection conn = DriverManager.getConnection("jdbc:postgresql://localhost:5432/ADDstudents", "postgres", "");

            Statement st=conn.createStatement();
        String sql= "DELETE FROM student1 WHERE ID="+add;
        PreparedStatement ptst= conn.prepareStatement(sql);
        ptst.executeUpdate();
